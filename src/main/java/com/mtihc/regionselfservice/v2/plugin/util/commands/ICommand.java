...
/**
 * Interface representing a command. <code>A method with the <code>Command</code> annotation can be wrapped in a class that implements this interface.</p>
 * 
 * @author Mitch
 */
public interface ICommand {
    ...
    /**
     * Returns the usage string. This is a forward slash, followed by the unique label, followed by the argument syntax.
     * 
