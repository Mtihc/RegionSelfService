...
public class DefineExactCommand extends SimpleCommand {
	...
	public DefineExactCommand(SimpleCommand parent, DefineExecutor executor, String permission) {
		super(parent, "-exact", null, permission, "You don't have permission to create exact regions.", "<id> [top-y] [bottom-y]", "Save the cuboid selection as protected region, overrides default top-y and bottom-y.");
	...
	protected boolean onCommand(CommandSender sender, String label,
		...
		try {
			...
			sender.sendMessage(ChatColor.RED
					+ "Invalid argument format. Expected integer number.");
			sender.sendMessage(getUsage());
			return false;
		}
