...
public class InfoCommand extends SimpleCommand {
	...
	public InfoCommand(SimpleCommand parent, String permission) {
		super(parent, "info", null, permission, "You don't have permission for the info command.", "[region] [world]", "Get info about a region. Look at a sign or specify the region name argument.");
