...
public class MessageControl {
	 ...
	 * 
	 */
	public MessageControl(EconomyControl economy) {
	 ...
	 * buyer  You bought region "id" for "cost" from "owners".
	 */
	public void bought(CommandSender buyer, Set<String> owners, Set<String> members, String regionId, double cost) {
		String ownerNames = toUserfriendlyString(owners);
		String permOwner = Permissions.INFORM_OWNER_SOLD;
		String permMember = Permissions.INFORM_MEMBER_SOLD;
	...
	public void rented(CommandSender renter, Set<String> owners, Set<String> members, String regionId, double cost, String time) {
		String ownerNames = toUserfriendlyString(owners);
		String permOwner = Permissions.INFORM_OWNER_RENTED;
		String permMember = Permissions.INFORM_MEMBER_RENTED;
	...
	public void upForSale(CommandSender seller, Set<String> owners, Set<String> members, String regionId, double cost) {
		String ownerNames = toUserfriendlyString(owners);
		String permOwner = Permissions.INFORM_OWNER_UPFORSALE;
		String permMember = Permissions.INFORM_MEMBER_UPFORSALE;
		// If the region is sold, the profits are shared amongst <owners>.
	...
	public void upForRent(CommandSender letter, Set<String> owners, Set<String> members, String regionId, double costPerTime, String time) {
		String ownerNames = toUserfriendlyString(owners);
		String permOwner = Permissions.INFORM_OWNER_UPFORRENT;
		String permMember = Permissions.INFORM_MEMBER_UPFORRENT;
	...
	public void removed(CommandSender remover, Set<String> owners, Set<String> members, String regionId, double refund) {
		String ownerNames = toUserfriendlyString(owners);
		String permOwner = Permissions.INFORM_OWNER_REMOVED;
		String permMember = Permissions.INFORM_MEMBER_REMOVED;
	...
	public void resized_bigger(CommandSender resizer, Set<String> owners, Set<String> members, String regionId, double cost, int oldWidth, int oldLength, int oldHeight, int newWidth, int newLength, int newHeight) {
		String permOwner = Permissions.INFORM_OWNER_RESIZE;
		String permMember = Permissions.INFORM_MEMBER_RESIZE;
